...
<head>
    ...
    <style>
        ...
        table.table td:last-child {
            width: 180px;
            /* Adjusted width to accommodate the buttons */
        }
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Actions">
                                <a href="{{ route('users.show', $user['id']) }}" class="btn btn-primary"
                                   ...
                                   <a href="{{ route('user.showProfile', ['user' => $user->id]) }}" class="btn btn-primary" title="User" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
